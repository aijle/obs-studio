...
set(CPACK_PACKAGE_NAME "MBO")
set(CPACK_PACKAGE_VENDOR "homca.com")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "MBO - Live video and audio streaming and recording software")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_EXECUTABLES
		"MBO32" "MBO Studio (32bit)"
		"MBO64" "MBO Studio (64bit)")
	...
	set(CPACK_PACKAGE_EXECUTABLES "MBO${_output_suffix}" "MBO Studio")
	set(CPACK_CREATE_DESKTOP_LINKS "MBO${_output_suffix}")
endif()

set(CPACK_BUNDLE_NAME "MBO")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "MBOStudio")
...
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
	if(WIN32)
		set(CPACK_PACKAGE_NAME "MBO Studio (64bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "MBOStudio64")
	...
	if(WIN32)
		set(CPACK_PACKAGE_NAME "MBO Studio (32bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "MBOStudio32")
